  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AssinaturasUsuariosRow:
            return AssinaturasUsuariosRow(data);
          case HistoricoUsoCuponsRow:
            return HistoricoUsoCuponsRow(data);
          case RegioesSaoPauloRow:
            return RegioesSaoPauloRow(data);
          case PlanosAssinaturaRow:
            return PlanosAssinaturaRow(data);
          case EstabelecimentosRow:
            return EstabelecimentosRow(data);
          case EstatisticasEstabelecimentosRow:
            return EstatisticasEstabelecimentosRow(data);
          case CuponsUsuariosRow:
            return CuponsUsuariosRow(data);
          case GaleriaEstabelecimentosRow:
            return GaleriaEstabelecimentosRow(data);
          case CategoriasEstabelecimentosRow:
            return CategoriasEstabelecimentosRow(data);
          case PromocoesRow:
            return PromocoesRow(data);
          case AvaliacoesRow:
